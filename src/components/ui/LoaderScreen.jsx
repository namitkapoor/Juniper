...
export default function LoaderScreen({ onLoadingComplete }) {
  ...
  useEffect(() => {
    ...
    const finalBlinkStart = setTimeout(() => setIsBlinking(true), 2300);  // Reduced from 3500
    const finalBlinkEnd = setTimeout(() => {
      setIsBlinking(false);
      setShowHappyEyes(true);
    }, 2450);  // Reduced from 3700

    const loadingTimer = setTimeout(() => {
      setIsLoading(false);
      setTimeout(onLoadingComplete, 1200);  // Reduced from 2000
    }, 3000);  // Reduced from 4500
          ...
          <div className="glasses-container">
            ...
            >
              ...
              <motion.path
                ...
                transition={{ duration: 2, ease: "easeInOut" }}  // Reduced from 3
              />
              <motion.path
                d="M90 35C90 23.9543 98.9543 15 110 15C121.046 15 130 23.9543 130 35C130 46.0457 121.046 55 110 55C98.9543 55 90 46.0457 90 35Z"
                stroke="white"
